...
if(isset($_POST['submit'])){
    ...
    if(isset($ten_sp)&&isset($tinh_trang)&&isset($he_may)&&isset($don_gia)&&isset($anh_sp)&&isset($id_dm_sp)&&isset($id_ncc)){
        ...
        $sql="INSERT INTO sanpham(id_danhmuc,id_ncc,ten_sp,tinh_trang,he_may,don_gia,anh_sp,noi_dung)
         VALUES('$id_dm_sp','$id_ncc','$ten_sp','$tinh_trang','$he_may','$don_gia','$anh_sp','$noi_dung')";
