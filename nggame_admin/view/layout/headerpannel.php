            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="menu-icon fa  fa-bars"></i>Danh mục bài viết</a>
                        <ul class="sub-menu children dropdown-menu">            
                        <li><i class="fa ti-angle-double-right"></i><a href="quantri.php?page_layout=quanlydanhmucbaiviet">Hiển thị danh sách</a></li>
                            <li><i class="fa ti-plus"></i><a href="quantri.php?page_layout=quanlydanhmucbaivietadd">&nbsp;Thêm danh mục bài viết</a></li>
                        </ul>
                    </li>
